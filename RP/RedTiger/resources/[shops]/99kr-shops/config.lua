Config = {
    ...
    Locations = {
        ...
        [3] = {
            ["shelfs"] = {
                {["x"] = -1222.56, ["y"] = -906.97, ["z"] = 12.32, ["value"] = "checkout"},
                {["x"] = -1226.27, ["y"] = -907.12, ["z"] = 12.32, ["value"] = "drinks"},
                {["x"] = -1223.97, ["y"] = -905.16, ["z"] = 12.32, ["value"] = "snacks"},
                {["x"] = -1225.50, ["y"] = -908.95, ["z"] = 12.32, ["value"] = "readymeal"},
                --{["x"] = -47.25, ["y"] = -1756.58, ["z"] = 29.42, ["value"] = "diverse"},
            },
            ["blip"] = {
    ...
    Items = {
        ["drinks"] = {
            ...
            {label = "Energisante", item = "energy", price = 7},
            {label = "Eau", item = "water", price = 2},
            {label = "Ice-tea", item = "icetea", price = 5},
        },
        ["snacks"] = {
            {label = "Pain", item = "bread", price = 3},
        },
        ["readymeal"] = {
            {label = "Pizza", item = "pizza", price = 10},
	    {label = "Hamburger", item = "hamburger", price = 14},
        },
        ["diverse"] = {
	    {label = "Telephone", item = "phone", price = 200},
	    {label = "Chargeur", item = "clip", price = 1000},            
        },
    },
}