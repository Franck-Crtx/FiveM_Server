Locales['fr'] = {
  ...
  ['received_paycheck'] = 'Premier salaire reçu',
  ['received_paycheck2'] = 'Deuxième salaire reçu',
  ['received_help2'] = 'Voici une aide secondaire',
  ['received_salary2'] = 'vous avez reçu votre salaire numéro 2: ~g~$%s~s~',
  ['bank'] = 'banque',
