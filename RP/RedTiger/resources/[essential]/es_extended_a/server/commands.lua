...
TriggerEvent('es:addGroupCommand', 'gangsbuilder', 'superadmin', function(source, args, user)
	TriggerClientEvent('token_1995:gb:OpenMenu', -1, args[1])
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
end, {help = _U('load_gang')})
