...
Radio.Labels = {        
    { "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " Enlever.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ Activer la radio ~g~on~s~.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ ou ~" .. radioConfig.Controls.Increase.Name .. "~ Changer de fréquence~n~~" .. radioConfig.Controls.Input.Name .. "~ Choisir une fréquence~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ pour ~a~ les bruits de micro~n~Fréquence: ~1~ MHz" },
    { "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " Enlever.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ Desactiver la radio ~r~off~s~.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ Parler.~n~Fréquence: ~1~ MHz" },
    { "FRZL_RADIO_INPUT", "Selection d'une frequence" },
}
Radio.Commands = {
    {
