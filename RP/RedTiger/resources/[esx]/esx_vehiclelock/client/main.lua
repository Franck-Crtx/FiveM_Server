...
--				 ESX.ShowNotification('Clé'), ("de voiture"), ("Vous avez ~r~fermé~s~ le véhicule.")
...
--				 ESX.ShowNotification('Clé'), ("de voiture"), ("Vous avez ~g~ouvert~s~ le véhicule.")
...
--			 ESX.ShowNotification('Clé'), ("de voiture"), ("~r~Vous n'avez pas les clés de ce véhicule.")
