	...
	menu.OnListSelect = function(sender, item, index)
		if item == gpsItem then
			...
			elseif actualGPS == "Hôpital" then
				SetNewWaypoint(291.21, -606.23)
			elseif actualGPS == "Crazy Pizza" then
				SetNewWaypoint(-570.25, -401.66)
			elseif actualGPS == "Concess Auto" then
				SetNewWaypoint(-33.88, -1102.37)
			elseif actualGPS == "Concess Moto" then
				SetNewWaypoint(289.57, -1154.03)
			elseif actualGPS == "Garage Central" then
				SetNewWaypoint(215.06, -791.56)
			elseif actualGPS == "LS Custom" then
				SetNewWaypoint(1037.72, -2299.28)
			elseif actualGPS == "Pôle Emploie" then
				SetNewWaypoint(-264.83, -964.54)
			elseif actualGPS == "Auto école" then
				SetNewWaypoint(231.34, 363.02)
