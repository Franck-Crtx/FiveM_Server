...
function Holograms()
		...
		if GetDistanceBetweenCoords( -1037.04,-2736.10, 20.169, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then

			Draw3DText( -1038.63,-2735.18, 20.169, "Bienvenue sur Red Tiger RP", 4, 0.1, 0.2)

			Draw3DText( -1034.59,-2737.91, 20.169, "Pour avoir de l'aide rejoignez le discord : ", 4, 0.1, 0.2)

			Draw3DText( -1034.59,-2737.91, 19.869, "~b~https://discord.gg/HSDur5n", 4, 0.1, 0.2)		
