	...
	window.addEventListener('message', function (event) {
		...
		switch (event.data.action) {
			...
			case 'updatePlayerJobs':
				...
				$('#motorcycle').html(jobs.motorcycle);
				$('#gouvernor').html(jobs.gouvernor);
				$('#bahama_mamas').html(jobs.bahama_mamas);
				$('#avocat').html(jobs.avocat);
				$('#unicorn').html(jobs.unicorn);
				$('#karting').html(jobs.karting);
				$('#pizza').html(jobs.pizza);
				break;
