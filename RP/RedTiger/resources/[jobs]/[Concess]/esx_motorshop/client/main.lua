			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'set_vehicle_owner_sell_amount', {
				...
				if amount == nil then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_motorcycle', _U('Moto'), tonumber(data2.value))
					end
				end
			end, function (data2, menu2)
				menu2.close()
                  ...
                  function(data2, menu2)
                    ...
                    local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
                      ...
                      if closestPlayer == -1 or closestDistance > 3.0 then
                        ...
                        TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_motorcycle', _U('Moto'), amount)
