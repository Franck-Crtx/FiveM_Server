  ...
  ESX.UI.Menu.Open(
...

    {
      ...
      elements = {
        ...
        --[{label = 'Réparer voiture',   value = 'fix_vehicle'}]--       
                  ...
                  function(data2, menu2)
                    ...
                    local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
                      ...
                      if closestPlayer == -1 or closestDistance > 3.0 then
                        ...
                        TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_cardealer', _U('Concesionnaire'), amount)
...
Citizen.CreateThread(function()
  while true do
    ...
    if IsControlJustReleased(0,  Keys['F6']) and ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name == 'cardealer' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'cardealer_actions') then
...
Citizen.CreateThread(function()
        while true do
            Citizen.Wait(1)    
                ...
                DrawAdvancedTextCNN(0.588, 0.14, 0.005, 0.0028, 0.8, "~o~ Concessions Auto ~d~", 255, 255, 255, 255, 1, 0)
