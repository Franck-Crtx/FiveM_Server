...
local pizzeria = { x = -563.909, y = -389.195, z = 34.032} --Configuration marker prise de service
local pizzeriafin = { x = -585.25, y = -385.13, z = 33.80} --Configuration marker fin de service
local spawnfaggio = { x = -576.58, y = -384.57, z = 33.80 } --Configuration du point de spawn du faggio
...
function spawn_faggio() -- Thread spawn faggio
  ...
  local vehicle = GetHashKey('foodbike')
