...
Config.PoliceCarMarker = 1 												-- marker type
...
Config.PoliceHeliMarker = 1 												-- marker type
...
Config.PoliceBoatMarker = 1 												-- marker type
...
Config.PoliceExtraMarker = 1 												-- marker type
...
Config.PoliceVehicles = {
		...
		{ model = 'pbike', label = 'LSPD Bike'},

		{ model = '', label = '-----Voitures-----'},

		{ model = 'newvic', label = 'Victoria'},

		{ model = '16taurus', label = 'Taurus'},

		{ model = '14charger', label = 'Charger-1'},

		{ model = 'police3', label = 'Cruiser'},

		{ model = '18charger', label = 'Charger-2'},

		{ model = '', label = '-----4x4-----'},

		{ model = '16explorer', label = 'Explorer'},

		{ model = '18tahoe', label = 'Tahoe'},

		{ model = '19durango', label = 'Durango'},

		{ model = '', label = '-----Banalises-----'},
		
		{ model = 'police4', label = 'Charger'},

		{ model = 'polschafter3', label = 'Schafter'},

		{ model = 'fbi2', label = 'Tahoe'},
		...
		{ model = 'pbus', label = 'Bus Penitentiaire'},

		{ model = 'policet', label = 'Fourgon de transport'},

		{ model = 'riot', label = 'Fourgon Blinde'},

		{ model = 'riot2', label = 'Fourgon anti-emeute'},

		{ model = '', label = '-----COMMANDANT(E)-----'},

		{ model = 'rmodpolice', label = 'Skyline'},
...
Config.CarOutFromPolGar = "Vous avez sorti un ~b~Vehicle~s~ du ~y~Police Garage~s~!"

Config.HeliOutFromPolGar = "Vous avez sorti un ~b~Helicopter~s~ du ~y~Police Heli Garage~s~!"

Config.BoatOutFromPolGar = "Vous avez sorti un ~b~Boat~s~ du ~y~Police Boat Garage~s~!"

Config.VehRepNotify = "Votre ~b~vehicle~s~ va être ~y~repaired~s~, attendez!"

Config.VehRepDoneNotify = "Votre ~b~vehicle~s~ a été ~y~repaired~s~!"

Config.VehCleanNotify = "Votre ~b~vehicle~s~ va être ~y~cleaned~s~, attendez!"

Config.VehCleanDoneNotify = "Votre ~b~vehicle~s~ a été ~y~cleaned~s~!"
...
Config.VehicleLoadText = "Attendez votre véhicule"			-- text on screen when vehicle model is being loaded
