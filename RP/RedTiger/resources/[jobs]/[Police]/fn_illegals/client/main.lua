...
function openInventory()
    ...
    ESX.TriggerServerCallback('esx_illegals:getInventory', function(result)
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'items_show', {css = 'vestiaire', title = "Illegals", align = 'right', elements = elements},

            function(data, menu)

                if data.current.value == "deposit" then

                    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'items_deposit', {css = 'vestiaire', title = "Items", align = 'right', elements = elements2},
