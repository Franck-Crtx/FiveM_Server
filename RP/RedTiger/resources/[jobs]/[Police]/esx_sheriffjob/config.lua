...
Config.AuthorizedVehicles = {
	Shared = {
		{ model = 'sheriff', label = 'Sheriff Cruiser', price = 10 },
		{ model = 'fixter', label = 'Velo', price = 10 }
	},
	...
	officer = {
		{ model = 'bcso1', label = 'Sheriff Cruiser 2', price = 10 },
		--{ model = 'sheriffvan', label = 'Sheriff Van', price = 10 },
		{ model = 'police4', label = 'Sheriff Banalisée', price = 10 }
	},

	sergeant = {
		{ model = 'bcso1', label = 'Sheriff Cruiser 2', price = 10 },
		--{ model = 'sheriffvan', label = 'Sheriff Van', price = 10 },
		{ model = 'bcso3', label = 'Sheriff Dodge', price = 10 },
		{ model = 'police4', label = 'Sheriff Banalisée', price = 10 },
		{ model = 'pranger', label = 'Sheriff SUV', price = 10 },
		{ model = 'policeb', label = 'Sheriff Moto', price = 10 },
		{ model = 'riot', label = 'Sheriff RIOT', price = 10 },
		{ model = 'pbus', label = 'Bus Pénitenciaire', price = 10 }
	},
	...
	lieutenant = {
		{ model = 'bcso1', label = 'Sheriff Cruiser 2', price = 10 },
		--{ model = 'sheriffvan', label = 'Sheriff Van', price = 10 },
		{ model = 'bcso6', label = 'Sheriff Dodge', price = 10 },
		{ model = 'police4', label = 'Sheriff Banalisée', price = 10 },
		{ model = 'pranger', label = 'Sheriff SUV', price = 10 },
		{ model = 'policeb', label = 'Sheriff Moto', price = 10 },
		{ model = 'riot', label = 'Sheriff RIOT', price = 10 },
		{ model = 'bcso4', label = 'Sheriff Moto', price = 10 },
		{ model = 'pbus', label = 'Bus Pénitenciaire', price = 10 }
	},
	...
	boss = {
		...
		{ model = 'policeb', label = 'Sheriff Moto', price = 10 },
		{ model = 'riot', label = 'Sheriff RIOT', price = 10 },
		{ model = 'bcso4', label = 'Sheriff SUV 2', price = 10 },
		{ model = 'bcso5', label = 'Sheriff SUV de Sheriff', price = 10 },
		{ model = 'bcso3', label = 'Sheriff Dodge de Sheriff', price = 10 },
		{ model = 'pbus', label = 'Bus Pénitenciaire', price = 10 }
