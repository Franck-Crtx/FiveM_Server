...
Config.FlashlightRemove = "Vous avez retiré une lampe de poche pour ~r~%s ~s~"
Config.ScopeEquipped = "Vous avez équipé une portée pour ~r~%s ~s~"
Config.ScopeRemove = "Vous avez supprimé une étendue pour ~r~%s ~s~"
Config.SuppressorEquipped = "Vous avez équipé une lunette~s~ pour ~r~%s ~s~"
Config.SuppressorRemove = "Vous avez supprimé une étendue~s~ pour ~r~%s ~s~"
...
Config.WeaponsInArmory = {
	...
	{ weaponHash = 'WEAPON_pumpshotgun', label = 'Fusil à pompe', type = 'shotguns', attachment = true, flashlight = 0x7BC4CDDC  },
