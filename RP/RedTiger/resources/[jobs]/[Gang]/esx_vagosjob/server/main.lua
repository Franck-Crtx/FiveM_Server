...
AddEventHandler('esx_vagos:getItem2', function( type, item, count)
  ...
  if type == 'item_standard' then
    ...
    TriggerEvent('esx_addoninventory:getSharedInventory', 'society_vagosboss',  function(inventory)
...
ESX.RegisterServerCallback('esx_vagos:getArmoryWeapons2', function(source, cb)
  ...
  TriggerEvent('esx_datastore:getSharedDataStore', 'society_vagosboss', function(store)
...
ESX.RegisterServerCallback('esx_vagos:getSocietyInventory', function(source, cb)
...
-------------------
ESX.RegisterServerCallback('esx_vagos:getSocietyInventory2', function(source, cb)
