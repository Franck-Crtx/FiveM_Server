...
function OpenArmoryMenu(station)
	...
	if Config.EnableArmoryManagement then
	  ...
	  if PlayerData.job2.name == 'ballas' and PlayerData.job2.grade_name == 'boss' then
			...
			if not DoesEntityExist(vehicle) then
				...
				if Config.MaxInService == -1 then
					...
					ESX.Game.SpawnVehicle(model, vehicles[partNum].SpawnPoint, vehicles[partNum].Heading, function(vehicle)
						SetVehicleCustomPrimaryColour(vehicle, 68, 16, 94) --Peinture primaire 189, 6, 226
						SetVehicleCustomSecondaryColour(vehicle, 68, 16, 94) --Peinture secondaire 239, 239, 239
						TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
...
function OpenSocietyInventoryMenu()
	...
	ESX.TriggerServerCallback('esx_ballas:getSocietyInventory', function(inventory)
  ...
  function OpenSocietyInventoryMenu2()
	...
	ESX.TriggerServerCallback('esx_ballas:getSocietyInventory2', function(inventory)
