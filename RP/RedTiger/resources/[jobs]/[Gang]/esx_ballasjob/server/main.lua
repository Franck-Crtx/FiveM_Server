...
AddEventHandler('esx_ballas:getItem2', function( type, item, count)
  ...
  if type == 'item_standard' then
    ...
    TriggerEvent('esx_addoninventory:getSharedInventory', 'society_ballasboss',  function(inventory)
...
ESX.RegisterServerCallback('esx_ballas:getArmoryWeapons2', function(source, cb)
  ...
  TriggerEvent('esx_datastore:getSharedDataStore', 'society_ballasboss', function(store)
...
ESX.RegisterServerCallback('esx_ballas:getSocietyInventory', function(source, cb)
...
-------------------
ESX.RegisterServerCallback('esx_ballas:getSocietyInventory2', function(source, cb)
