Locales['fr'] = {
  ...
  ['owner'] = 'Propriétaire : ',
  -- Weapons Menus
  ['get_weapon_menu'] = 'Families - Prendre Arme',
  ['put_weapon_menu'] = 'Families - Déposer Arme',
  ['buy_weapon_menu'] = 'Families - Acheter Armes',
  ...
  ['quantity'] = 'Quantité',
  ['get_stock'] = 'Families - Prendre Objet',
  ['put_stock'] = 'Families - Déposer Objet',
  ['grade'] = 'Grade',
  -- Notifications
  ['from'] = '~s~ à ~b~',
