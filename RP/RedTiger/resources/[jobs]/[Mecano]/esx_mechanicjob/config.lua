...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = {x = 1008.955, y = -2314.523, z = 29.509},
	...
	Garage = {
		Pos   = { x = 1000.078, y = -2339.453, z = 29.509 },
		Size  = { x = 1.5, y = 1.5, z = 0.3 },
		Color = { r = 0, g = 255, b = 0 },
		Type  = 1
	},
	...
	Craft = {
		Pos   = { x = 1012.663, y = -2333.406, z = 29.509 },
		Size  = { x = 1.5, y = 1.5, z = 0.3 },
		Color = { r = 0, g = 255, b = 0 },
		Type  = 1
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = 1011.901, y = -2374.440, z = 30.531	 },
		Size  = { x = 1.5, y = 1.5, z = 0.3 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = 992.164, y = -2313.344, z = 29.509 },
