...
Config.Zones = {
    ...
    BossActions = {
        Pos   = { x = -1390.158, y = -600.440, z = 29.500 },
        Size  = { x = 1.0, y = 1.0, z = 1.0 },
        Color = { r = 0, g = 100, b = 0 },
        Type  = 1,
    },
...
-------- SHOPS --------
    ...
    Flacons = {
        Pos   = { x = -1390.413, y = -607.093, z = 29.419 },
        Size  = { x = 1.6, y = 1.6, z = 1.0 },
        Color = { r = 238, g = 0, b = 0 },
        Type  = 23,
        Items = {
    ...
    NoAlcool = {
        Pos   = { x = -1391.774, y = -605.018, z = 29.419 },
        Size  = { x = 1.6, y = 1.6, z = 1.0 },
        Color = { r = 238, g = 110, b = 0 },
        Type  = 23,
        Items = {
            { name = 'soda',        label = _U('soda'),     price = 5 },
            { name = 'jusfruit',    label = _U('jusfruit'), price = 5 },
            { name = 'icetea',      label = _U('icetea'),   price = 5 },
            { name = 'energy',      label = _U('energy'),   price = 5 },
            { name = 'drpepper',    label = _U('drpepper'), price = 5 },
            { name = 'limonade',    label = _U('limonade'), price = 5 }
        },
    },

    Apero = {
        Pos   = { x = -1392.389, y = -603.102, z = 29.419 },
        Size  = { x = 1.6, y = 1.6, z = 1.0 },
    ...
    Ice = {
        Pos   = { x = -1388.787, y = -608.830, z = 29.419 },
        Size  = { x = 1.6, y = 1.6, z = 1.0 },
        Color = { r = 255, g = 255, b = 255 },
        Type  = 23,
        Items = {
            { name = 'ice',     label = _U('ice'),      price = 5 },
            { name = 'menthe',  label = _U('menthe'),   price = 10 }
        },
    },
...
----- TELEPORTERS -----
 ...
 Config.TeleportZones = {
  ...
  EnterHeliport = {
    Pos       = { x = -1350.425, y = -634.940, z = 26.700 },
